    ...
    public partial class AddAirportTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Star Alliance", "TK", "TR", new DateTime(2026, 4, 4, 15, 20, 6, 190, DateTimeKind.Utc).AddTicks(5030), true, true, "/assets/airlines/tk.png", "Turkish Airlines", "Türk Hava Yolları", 1, null },
                    { 2, null, "PC", "TR", new DateTime(2026, 4, 4, 15, 20, 6, 190, DateTimeKind.Utc).AddTicks(5035), true, true, "/assets/airlines/pc.png", "Pegasus Airlines", "Pegasus Hava Yolları", 2, null },
                    { 3, null, "VF", "TR", new DateTime(2026, 4, 4, 15, 20, 6, 190, DateTimeKind.Utc).AddTicks(5036), true, true, "/assets/airlines/vf.png", "AnadoluJet", "AnadoluJet", 3, null },
                    { 4, null, "XQ", "TR", new DateTime(2026, 4, 4, 15, 20, 6, 190, DateTimeKind.Utc).AddTicks(5038), true, true, "/assets/airlines/xq.png", "SunExpress", "SunExpress", 4, null },
                    { 5, null, "XC", "TR", new DateTime(2026, 4, 4, 15, 20, 6, 190, DateTimeKind.Utc).AddTicks(5039), true, true, "/assets/airlines/xc.png", "Corendon Airlines", "Corendon Airlines", 5, null },
                    { 6, "Star Alliance", "LH", "DE", new DateTime(2026, 4, 4, 15, 20, 6, 190, DateTimeKind.Utc).AddTicks(5041), true, false, "/assets/airlines/lh.png", "Lufthansa", "Lufthansa", 10, null },
                    { 7, "Oneworld", "BA", "GB", new DateTime(2026, 4, 4, 15, 20, 6, 190, DateTimeKind.Utc).AddTicks(5042), true, false, "/assets/airlines/ba.png", "British Airways", "British Airways", 11, null },
                    { 8, "SkyTeam", "AF", "FR", new DateTime(2026, 4, 4, 15, 20, 6, 190, DateTimeKind.Utc).AddTicks(5043), true, false, "/assets/airlines/af.png", "Air France", "Air France", 12, null },
                    { 9, null, "EK", "AE", new DateTime(2026, 4, 4, 15, 20, 6, 190, DateTimeKind.Utc).AddTicks(5045), true, false, "/assets/airlines/ek.png", "Emirates", "Emirates", 13, null },
                    { 10, "Oneworld", "QR", "QA", new DateTime(2026, 4, 4, 15, 20, 6, 190, DateTimeKind.Utc).AddTicks(5046), true, false, "/assets/airlines/qr.png", "Qatar Airways", "Qatar Airways", 14, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 4, 4, 15, 20, 6, 190, DateTimeKind.Utc).AddTicks(5509), "TRY", "AYT", 899.00m, true, "IST", 1, null },
                    { 2, new DateTime(2026, 4, 4, 15, 20, 6, 190, DateTimeKind.Utc).AddTicks(5514), "TRY", "ADB", 749.00m, true, "IST", 2, null },
                    { 3, new DateTime(2026, 4, 4, 15, 20, 6, 190, DateTimeKind.Utc).AddTicks(5515), "TRY", "TZX", 699.00m, true, "IST", 3, null },
                    { 4, new DateTime(2026, 4, 4, 15, 20, 6, 190, DateTimeKind.Utc).AddTicks(5517), "TRY", "IST", 599.00m, true, "ESB", 4, null },
                    { 5, new DateTime(2026, 4, 4, 15, 20, 6, 190, DateTimeKind.Utc).AddTicks(5518), "TRY", "BJV", 949.00m, true, "IST", 5, null },
                    { 6, new DateTime(2026, 4, 4, 15, 20, 6, 190, DateTimeKind.Utc).AddTicks(5519), "TRY", "AYT", 799.00m, true, "ESB", 6, null }
                });
