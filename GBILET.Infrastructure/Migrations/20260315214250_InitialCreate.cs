        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TicketedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BiletBankCost = table.Column<decimal>(type: "numeric", nullable: true),
                    OurPrice = table.Column<decimal>(type: "numeric", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Star Alliance", "TK", "TR", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(6114), true, true, "/assets/airlines/tk.png", "Turkish Airlines", "Türk Hava Yolları", 1, null },
                    { 2, null, "PC", "TR", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(6117), true, true, "/assets/airlines/pc.png", "Pegasus Airlines", "Pegasus Hava Yolları", 2, null },
                    { 3, null, "VF", "TR", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(6118), true, true, "/assets/airlines/vf.png", "AnadoluJet", "AnadoluJet", 3, null },
                    { 4, null, "XQ", "TR", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(6120), true, true, "/assets/airlines/xq.png", "SunExpress", "SunExpress", 4, null },
                    { 5, null, "XC", "TR", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(6121), true, true, "/assets/airlines/xc.png", "Corendon Airlines", "Corendon Airlines", 5, null },
                    { 6, "Star Alliance", "LH", "DE", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(6122), true, false, "/assets/airlines/lh.png", "Lufthansa", "Lufthansa", 10, null },
                    { 7, "Oneworld", "BA", "GB", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(6124), true, false, "/assets/airlines/ba.png", "British Airways", "British Airways", 11, null },
                    { 8, "SkyTeam", "AF", "FR", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(6125), true, false, "/assets/airlines/af.png", "Air France", "Air France", 12, null },
                    { 9, null, "EK", "AE", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(6126), true, false, "/assets/airlines/ek.png", "Emirates", "Emirates", 13, null },
                    { 10, "Oneworld", "QR", "QA", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(6128), true, false, "/assets/airlines/qr.png", "Qatar Airways", "Qatar Airways", 14, null }
                });

            migrationBuilder.InsertData(
                table: "Airports",
                columns: new[] { "Id", "CityEn", "CityTr", "CountryCode", "CountryEn", "CountryTr", "CreatedAt", "IataCode", "IcaoCode", "IsActive", "IsCity", "IsDomestic", "NameEn", "NameTr", "SortOrder", "Timezone", "UpdatedAt" },
                values: new object[,]
                {
                    { 1, "Istanbul", "İstanbul", "TR", "Turkey", "Türkiye", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(5691), "IST", "LTFM", true, false, true, "Istanbul Airport", "İstanbul Havalimanı", 1, "Europe/Istanbul", null },
                    { 2, "Istanbul", "İstanbul", "TR", "Turkey", "Türkiye", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(5697), "SAW", "LTFJ", true, false, true, "Sabiha Gokcen Airport", "Sabiha Gökçen Havalimanı", 2, "Europe/Istanbul", null },
                    { 3, "Ankara", "Ankara", "TR", "Turkey", "Türkiye", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(5699), "ESB", "LTAC", true, false, true, "Esenboga Airport", "Esenboğa Havalimanı", 3, "Europe/Istanbul", null },
                    { 4, "Izmir", "İzmir", "TR", "Turkey", "Türkiye", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(5701), "ADB", "LTBJ", true, false, true, "Adnan Menderes Airport", "Adnan Menderes Havalimanı", 4, "Europe/Istanbul", null },
                    { 5, "Antalya", "Antalya", "TR", "Turkey", "Türkiye", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(5703), "AYT", "LTAI", true, false, true, "Antalya Airport", "Antalya Havalimanı", 5, "Europe/Istanbul", null },
                    { 6, "Trabzon", "Trabzon", "TR", "Turkey", "Türkiye", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(5705), "TZX", "LTCG", true, false, true, "Trabzon Airport", "Trabzon Havalimanı", 6, "Europe/Istanbul", null },
                    { 7, "Mugla", "Muğla", "TR", "Turkey", "Türkiye", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(5707), "BJV", "LTFE", true, false, true, "Milas-Bodrum Airport", "Milas-Bodrum Havalimanı", 7, "Europe/Istanbul", null },
                    { 8, "Mugla", "Muğla", "TR", "Turkey", "Türkiye", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(5709), "DLM", "LTBS", true, false, true, "Dalaman Airport", "Dalaman Havalimanı", 8, "Europe/Istanbul", null },
                    { 9, "Gaziantep", "Gaziantep", "TR", "Turkey", "Türkiye", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(5711), "GZT", "LTAJ", true, false, true, "Gaziantep Airport", "Gaziantep Havalimanı", 9, "Europe/Istanbul", null },
                    { 10, "Kayseri", "Kayseri", "TR", "Turkey", "Türkiye", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(5714), "ASR", "LTAP", true, false, true, "Kayseri Airport", "Kayseri Havalimanı", 10, "Europe/Istanbul", null },
                    { 11, "Van", "Van", "TR", "Turkey", "Türkiye", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(5716), "VAN", "LTCI", true, false, true, "Van Ferit Melen Airport", "Van Ferit Melen Havalimanı", 11, "Europe/Istanbul", null },
                    { 12, "Diyarbakir", "Diyarbakır", "TR", "Turkey", "Türkiye", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(5718), "DIY", "LTCC", true, false, true, "Diyarbakir Airport", "Diyarbakır Havalimanı", 12, "Europe/Istanbul", null },
                    { 13, "Samsun", "Samsun", "TR", "Turkey", "Türkiye", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(5720), "SZF", "LTFH", true, false, true, "Samsun-Carsamba Airport", "Samsun-Çarşamba Havalimanı", 13, "Europe/Istanbul", null },
                    { 14, "Erzurum", "Erzurum", "TR", "Turkey", "Türkiye", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(5722), "ERZ", "LTCE", true, false, true, "Erzurum Airport", "Erzurum Havalimanı", 14, "Europe/Istanbul", null },
                    { 15, "Konya", "Konya", "TR", "Turkey", "Türkiye", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(5724), "KYA", "LTAN", true, false, true, "Konya Airport", "Konya Havalimanı", 15, "Europe/Istanbul", null },
                    { 16, "Malatya", "Malatya", "TR", "Turkey", "Türkiye", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(5726), "MLX", "LTAT", true, false, true, "Malatya Airport", "Malatya Havalimanı", 16, "Europe/Istanbul", null },
                    { 17, "Elazig", "Elazığ", "TR", "Turkey", "Türkiye", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(5728), "EZS", "LTCA", true, false, true, "Elazig Airport", "Elazığ Havalimanı", 17, "Europe/Istanbul", null },
                    { 18, "Ordu", "Ordu", "TR", "Turkey", "Türkiye", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(5730), "OGU", "LTCN", true, false, true, "Ordu-Giresun Airport", "Ordu-Giresun Havalimanı", 18, "Europe/Istanbul", null },
                    { 19, "Hatay", "Hatay", "TR", "Turkey", "Türkiye", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(5732), "HTY", "LTDA", true, false, true, "Hatay Airport", "Hatay Havalimanı", 19, "Europe/Istanbul", null },
                    { 20, "Nevsehir", "Nevşehir", "TR", "Turkey", "Türkiye", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(5735), "NAV", "LTAZ", true, false, true, "Nevsehir Cappadocia Airport", "Nevşehir Kapadokya Havalimanı", 20, "Europe/Istanbul", null },
                    { 21, "Eskisehir", "Eskişehir", "TR", "Turkey", "Türkiye", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(5737), "AOE", "LTBY", true, false, true, "Eskisehir Anadolu Airport", "Eskişehir Anadolu Havalimanı", 21, "Europe/Istanbul", null },
                    { 22, "London", "Londra", "GB", "United Kingdom", "İngiltere", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(5739), "LHR", "EGLL", true, false, false, "London Heathrow Airport", "Londra Heathrow Havalimanı", 100, "Europe/London", null },
                    { 23, "Paris", "Paris", "FR", "France", "Fransa", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(5741), "CDG", "LFPG", true, false, false, "Paris Charles de Gaulle Airport", "Paris Charles de Gaulle Havalimanı", 101, "Europe/Paris", null },
                    { 24, "Frankfurt", "Frankfurt", "DE", "Germany", "Almanya", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(5743), "FRA", "EDDF", true, false, false, "Frankfurt Airport", "Frankfurt Havalimanı", 102, "Europe/Berlin", null },
                    { 25, "Amsterdam", "Amsterdam", "NL", "Netherlands", "Hollanda", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(5745), "AMS", "EHAM", true, false, false, "Amsterdam Schiphol Airport", "Amsterdam Schiphol Havalimanı", 103, "Europe/Amsterdam", null },
                    { 26, "Dubai", "Dubai", "AE", "United Arab Emirates", "Birleşik Arap Emirlikleri", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(5747), "DXB", "OMDB", true, false, false, "Dubai International Airport", "Dubai Uluslararası Havalimanı", 104, "Asia/Dubai", null },
                    { 27, "New York", "New York", "US", "United States", "Amerika Birleşik Devletleri", new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(5750), "JFK", "KJFK", true, false, false, "John F. Kennedy International Airport", "New York JFK Havalimanı", 105, "America/New_York", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(6236), "TRY", "AYT", 899.00m, true, "IST", 1, null },
                    { 2, new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(6243), "TRY", "ADB", 749.00m, true, "IST", 2, null },
                    { 3, new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(6245), "TRY", "TZX", 699.00m, true, "IST", 3, null },
                    { 4, new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(6246), "TRY", "IST", 599.00m, true, "ESB", 4, null },
                    { 5, new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(6247), "TRY", "BJV", 949.00m, true, "IST", 5, null },
                    { 6, new DateTime(2026, 3, 15, 21, 42, 50, 377, DateTimeKind.Utc).AddTicks(6249), "TRY", "AYT", 799.00m, true, "ESB", 6, null }
                });
